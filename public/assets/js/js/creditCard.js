                    ...
                    for (var i = creditCardlen-1; i >= 0; i--) { 
                        ...
                        if (admin_credit_len > 0) {
                            for (var j = admin_credit_len-1; j >= 0; j--) {
                                ...
                                if(deleteStatus == "NO"){
                                        //alert("ff");
                                        var creditCardStr = "<tr class='tr' data-id=" + (i + 1) + ">" +
                                        ...
                                        "<td style='text-align:center'>"+
                                            "<a class='button-23 edit_modalCreditCard'  title='Edit1' data-creditCardId='"+admin_bank_Id+"' data-compID='"+com_Id+"'><i class='fe fe-edit'></i></a>&nbsp"+

                                            "<a class='button-23 delete_modalCreditCard'  title='delete' data-creditCardId='"+admin_bank_Id+"' data-compID='"+com_Id+"' ><i class='fe fe-trash'></i></a>&nbsp"+
                                        "</td></tr>";
