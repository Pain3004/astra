              ...
              //alert(fuelCardId);
                        ...
                        if(deleteStatus == "NO"){
                            ...
                            "<td style='text-align:center'>"+
                                "<a class='button-23  "+editPrivilege+" edit_fuel_receipts_form'  title='Edit1'  data-fuelReId='"+fuelReceiptId+"' data-com_Id='"+custID+"'  ><i class='fe fe-edit'></i></a>&nbsp"+
                                "</a> <a class='delete1 button-23 "+delPrivilege+" delete_fuel_receipts_form'  data-fuelReId='"+fuelReceiptId+"' data-com_Id='"+custID+"'  title='Delete'><i class='fe fe-delete'></i></a>"+
                            "</td></tr>";
