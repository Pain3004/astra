...
$(document).ready(function() {
                        ...
                        $.each(data, function(i, v) { 
                            ...
                            if(deleteStatus == "NO"){
                                ...
                                "<td style='text-align:center'>"+
                                    "<a class='button-23   edit_fuel_receipts_form'  title='Edit1'  data-fuelReId='"+fuelReceiptId+"' data-com_Id='"+custID+"'  ><i class='fe fe-edit'></i></a>&nbsp"+
                                    "</a> <a class='delete1 button-23  delete_fuel_receipts_form'  data-fuelReId='"+fuelReceiptId+"' data-com_Id='"+custID+"'  title='Delete'><i class='fe fe-delete'></i></a>"+
                                "</td></tr>";
    ...
    function removePagi()
    {
        ...
        var startItem=0;
        var endItem=10;
        $('#fuelReceiptPagiTable tbody tr').css('opacity','0.0').hide().slice(startItem, endItem).  
        css('display','table-row').animate({opacity:1}, 300); 
    }
    function Paginator(items) 
    {

        $('#fuelReceiptPagiTable').after ('<div id="nav"></div>');  
        var rowsShown = 10;  
        var rowsTotal = items;  
        ...
        $('#fuelReceiptPagiTable tbody tr').hide();  
        $('#fuelReceiptPagiTable tbody tr').slice (0, rowsShown).show();  
