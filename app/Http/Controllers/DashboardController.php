   ...
   public function customerdata(Request $request) 
    {
        ...
        foreach ($company_status as $com) 
        {
            ...
            {
                // dd($comdata);
                if (array_key_exists('paytype',(array)$comdata)) 
                {
    ...
    public function dashpayable(Request $request)
    {
        ...
        foreach ($payable as $pl) 
        {
            ...
            foreach ($load_data as $ld) 
            {
                ...
                if (array_key_exists("paiddate", (array)$ld)) 
                {
                    if (empty($ld['paiddate'])) 
                    {
                        if (array_key_exists("invoice_received_date",(array)$ld)) {
        ...
        foreach ($status_load as $ag) 
        {
            ...
            foreach ($load as $agd) 
            {
                if(array_key_exists("receivedate", (array)$agd))
                {
    ...
    public function driverpayStatement(Request $request)
    {
        ...
        //                 $skipped = array();
        //                 if(array_key_exists("skiprecurrence", (array)$add))
        //                 {
        ...
        //                 $skipped = array();
        //                 if(array_key_exists("skiprecurrence", (array)$sub))
        //                 {
        ...
        //             {    
        //                 if (array_key_exists('paiddate', (array)$dps1)) 
        //                 {
        ...
        //                         if(array_key_exists($dps1["truck"], (array)$truckType))
        //                         {
        ...
        //                             $drivertruck = "";
        //                         }
        //                         if(array_key_exists($dps1["trailer"], (array)$trailerType))
        //                         {
