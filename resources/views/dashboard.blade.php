              ...
              <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3 item">
								<div class="card overflow-hidden card-now">
									<div class="card-body gradient-5">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="estdrvpay"><span class="text-muted mb-0 mt-2 fs-12" id="toolestdrvpay"></span></h3>
												<p class="text-muted fs-13 mb-0"> Estimated Driver Pay</p>
              ...
              <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3 item">
								<div class="card overflow-hidden card-now">
									<div class="card-body gradient-6">
										<div class="row">
											<div class="col">
												<h3 class="mb-2 fw-semibold" id="panddingamt"> <span class="text-muted mb-0 mt-2 fs-12"  id="penddingtool"></span></h3>
												<p class="text-muted fs-13 mb-0" id="estdp"></p>
												<!-- <p class="text-muted mb-0 mt-2 fs-12">
													<span class="icn-box text-success fw-semibold fs-13 me-1">
														<i class="fa fa-long-arrow-up"></i>
														42%</span>
          ...
          <div class="col-sm-12 col-md-12 col-xl-4 col-lg-6 ">
            <div class="row">
              ...
              <div class="col-xl-5"  style="display:flex">
                <i class="mdi mdi-play-circle float-right tour-icon" id="dashboard_tour" title="Take a Tour" style="margin-top: -8px;font-size:35px"></i>
                            ...
                            <div class="card-body custom-card" style="padding:0rem">
                              <div class="wrapper__header">
                                <div class=""><img src="{{URL::to('/')}}/assets/images/cup.png" height="45" width="45"></div>
                                  <div class="b_caption">
                                  <span id="ranking_table" style="float:left">Customer Loads</span>
                                </div>
                              </div>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
                    <div class="card">
                      <div class="card-header border-hide">
                        <h5 class="custome-line"><span class="baricone"><i class="mdi mdi-coin"></i></span><span class=""></span>&nbsp;<span class="">Customer Loads
