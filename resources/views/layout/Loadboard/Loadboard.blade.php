                                                    ...
                                                    <div class="col-8">
                                                        <div class="btn-group submitter-group float-right">
                                                            ...
                                                            <ul class="filter-wrapper ks-cboxtags">
                                                                <li><input type="checkbox" class="filter-checkbox" id="checkboxOne" value="Software Engineer"><label for="checkboxOne">Software Engineer</label></li>
                                                                <li><input type="checkbox" class="filter-checkbox" id="checkboxTwo" value="Accountant"><label for="checkboxTwo">Accountant</label></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
