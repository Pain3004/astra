                            ...
                            <div class="navbar navbar-collapse responsive-navbar p-0">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
										...
										<!-- <div class="dropdown d-md-flex">
											<a href="{{URL::to('/')}}" id="" class="button-70 add-button" style="color: white; height: 70%;">Login</a>
											<div class="text-center p-1 d-flex d-lg-none-max">
												<h6 class="mb-0" id="profile-heading"><a href="{{URL::to('/')}}">Login</a><i class="user-angle ms-1 fa fa-angle-down "></i></h6>
											</div>
										</div> -->
                                        
										<div class="dropdown d-md-flex profile-1">
												<a  data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
													<div class="text-center p-1 d-flex d-lg-none-max">
														<h6 class="mb-0" id="profile-heading"><a href="{{URL::to('/')}}">Login</a><i class="user-angle ms-1 fa fa-angle-down "></i></h6>
													</div>
												</a>
